    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <label for="pengirim">Tanggal Publish</label>
                <input type="date" class="form-control" name="tanggal_publish" id ="tanggal_publish" placeholder="Tanggal Publish" required>
            </div>
