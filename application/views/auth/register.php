    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-tittle">Form Registrasi</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="konfirmasi">Konfirmasi Passowrd</label>
                            <input type="text" class="form-control" name="confirm_password" id="confirm_password" placeholder="Konfirmasi Passoword" required>
                        </div> 
                        <div class="form-group">
